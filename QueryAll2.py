...
# Ensure that addresses are converted to integers and filter out invalid entries
addresses = input_registers_df['Address (DEC)']
addresses = addresses.dropna()  # Remove any NaN values
addresses = addresses.astype(int).tolist()  # Convert remaining valid addresses to integers
    ...
    while True:
        ...
        for address in addresses:
            try:
                ...
                register_values.append('Error')  # Log 'Error' in case of exception
